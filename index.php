...
<head>
    <meta charset="utf-8">
    <title>Home Appliances Mechanic - AAA Website </title>
        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-7 px-5 text-start">
                ...
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <small>acmechanic@gmail.com</small>
                </div>
            </div>
          </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="h-100 d-lg-inline-flex align-items-center d-none">
                 <a class="btn btn-square rounded-circle bg-light text-primary me-2" href=""><i class="fa  fa-phone-alt"></i></a>
                <a class="btn btn-square rounded-circle bg-light text-primary me-2" href="https://www.facebook.com/share/1Ske9GEXqT/"><i class="fab fa-facebook-f"></i></a>
                  <a class="btn btn-square rounded-circle bg-light text-primary me-2" href="https://wa.me/+918098733569/"><i class="fab fa-whatsapp fa-lg"></i></a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 pt-5">
                                    <h1 class="display-4 text-white mb-4 animated slideInDown">Trusted Service Center</h1>
...
<!-- team stard -->
 <div class="container-xxl py-5">
        <?php include "db.php"; ?>
        <h1 class="display-6 text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px; mb-4">Meet Our Professional Team Members</h1>

<?php
// fetch all cities
$cityQuery = mysqli_query($conn, "SELECT * FROM city");
...
?>
    ...
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            ...
            <h2 class="h3 mx-4 mb-3 text-primary"><?php echo $city_name; ?> Mechanic</h2>
        </div>

        <div class="row g-4">
            <?php
            // fetch mechanics belonging to this city
            $mechQuery = mysqli_query($conn, 
                "SELECT * FROM mechanic WHERE area = '$city_name'"
            );

            // if no mechanics found
            if (mysqli_num_rows($mechQuery) == 0) {
                echo "<p class='text-center text-muted'>No mechanics available in $city_name</p>";
            }

            // loop mechanics
            while ($mech = mysqli_fetch_assoc($mechQuery)) {
            ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">

                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid" src="uploads/<?php echo $mech['profile_img']; ?>" alt="">

                            <div class="team-social">
                                <a class="btn btn-square btn-primary rounded-circle m-1" href="https://wa.me/<?php echo $mech['whatsapp']; ?>"><i class="fab fa-whatsapp"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle m-1" href="<?php echo $mech['mobile']; ?>"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle m-1" href="tel:<?php echo $mech['email']; ?>"><i class="fa fa-phone-alt"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle m-1" href="<?php echo $mech['status']; ?>"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>

                        <div class="bg-light text-center p-4">
                            <h5><?php echo $mech['name']; ?></h5>
                            <span class="text-primary"><?php echo $mech['experience']; ?></span>
                        </div>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <p class="mb-4">An expert AC technician is a skilled professional who inspects, repairs, and maintains air conditioning systems, from diagnosing problems to performing preventative maintenance and installing new equipment</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0">acmechanic@gmail.com</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <!-- <p class="mb-5">Our certified technicians provide prompt, reliable service with guaranteed quality, ensuring your system runs efficiently and safely. We offer transparent pricing and long-term, cost-effective solutions for all your cooling needs.</p> -->
                    <div class="d-flex mb-5">
                        ...
                        <div class="ms-4">
                            ...
                            <span>Our certified technicians provide prompt, reliable service with guaranteed quality.</span>
                        </div>
                    </div>
                    <div class="d-flex mb-5">
                        <div class="flex-shrink-0 btn-square bg-primary rounded-circle" style="width: 90px; height: 90px;">
                        ...
                        <div class="ms-4">
                            ...
                            <span>ensuring your system runs efficiently and safely. We offer transparent pricing and long-term, cost-effective solutions for all your cooling needs.</span>
                        </div>
                    </div>
                    <div class="d-flex mb-0">
                        ...
                        <div class="ms-4">
                            ...
                            <span>We offer transparent pricing and long-term, cost-effective solutions for all your cooling needs</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 quote-text" data-parallax="scroll" data-image-src="img/carousel-1.jpg">
                    <div class="h-100 px-4 px-sm-5 ps-lg-0 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <a href="about.html" class="align-self-start btn btn-primary py-3 px-5">More Details</a>
                    </div>
                </div>
                    ...
                    <div class="h-100 px-4 px-sm-5 pe-lg-0 wow fadeIn" data-wow-delay="0.5s">
                        <div class="bg-white p-4 p-sm-5">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                 <a href="https://wa.me/+918098733569/"> <button  class="btn btn-primary py-3 px-5" type="submit">Done</button></a>  
                                </div>
                            </div>
                            </div>
                        </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input class="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="Your Feedback">
                        <button type="button" class="btn btn-primary py-2 px-3 position-absolute top-0 end-0 mt-2 me-2">Send</button>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-light mb-4">Get In Touch</h5>
                    <p><i class="fa fa-map-marker-alt me-3"></i>123 Street, Aruppukottai</p>
                    <p><i class="fa  fa-phone-alt me-3"></i>+012 345 67890</p>
                    <p><i class="fa fa-envelope me-3"></i>acmechanic@gmail.com</p>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex">
                       <a class="btn btn-square rounded-circle me-1" href="tel:918098733569"><i class="fa  fa-phone-alt"></i></a>
                        <a class="btn btn-square rounded-circle me-1" href=""><i class="fab fa-whatsapp"></i></a>
                         <a class="btn btn-square rounded-circle me-1" href="https://www.facebook.com/share/1Ske9GEXqT/"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a>AAA Mechanic Site </a>, All Right Reserved.
                    </div>
